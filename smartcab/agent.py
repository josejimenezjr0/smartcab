...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = math.pow(self.a, self.trial_num)
            # self.epsilon = 1 / (math.pow(self.trial_num, 2))
            # self.epsilon = math.exp(-1 * self.a * self.trial_num)
    ...
    def build_state(self):
        ...
        #DONE## TO DO ### Set 'state' as a tuple of relevant data for the agent
